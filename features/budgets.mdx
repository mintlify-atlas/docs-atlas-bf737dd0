...
| `tipo` | string (max 60 chars) | Project type — same options as a regular project (Construcción, Remodelación, Muebles, Mantenimiento, Otro) |
| `utilidad_pct` | decimal (≥ 0) | Desired utility/markup percentage applied on top of total cost |
