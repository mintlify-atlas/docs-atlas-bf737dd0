---
title: "Authenticating with the Gestor Financiero API"
...
In JavaScript, the frontend reads the token from `document.cookie` and injects it automatically for all `POST`, `PUT`, and `DELETE` requests:
